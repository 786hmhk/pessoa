function [sys, x0, str, ts] = sfunxy_obs(t,x,u,flag,ax,varargin)
%   SFUNXY_OBS is a customized version of SFUNXY S-function that acts as 
%   an X-Y scope using MATLAB plotting functions. This customization only
%   adds some red blocks acting as obstacles.
...
if isempty(ud.XData),
  ...
  y_data = [u(2) u(2)];
    ...
    Obstacle2 = surface(...
      'Parent',   ud.XYAxes,...
      'XData',    ones(2,1)*[2.8 3],...
      'YData',    [2 2; 5 5],...
      'ZData',    zeros(2),...
      'CData',    ones(2));               
    Obstacle3 = surface(...
      'Parent',   ud.XYAxes,...
      'XData',    ones(2,1)*[3.8 4],...
      'YData',    [1 1; 4 4],...
      'ZData',    zeros(2),...
      'CData',    ones(2));               
    ...
    Target = surface(...
      'Parent',   ud.XYAxes,...
      'XData',    ones(2,1)*[4.6 5],...
      'YData',    [1 1; 1.6 1.6],...
      'ZData',    zeros(2),...
      'CData',    10*ones(2));               

    ud.Obstacle1 = Obstacle1;
    ud.Obstacle2 = Obstacle2;
    ud.Obstacle3 = Obstacle3;
    ud.Target = Target;

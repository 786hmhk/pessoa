...
DCMotor_cont.B=[0 0; 1/L 1/L];                    % B matrix
...
DCMotor_symb.uset=[-10 10,1 1];            % Range of values for the input
                                           % I add another input and forced
                                           % it to stay at 1 
                                           
DCMotor_symb.tau=0.05;                     % Time quantization
DCMotor_symb.eta=0.5;                      % State quantization
DCMotor_symb.mu=2;                         % Input quantization
DCMotor_symb.epsilon=1;                    % I add this epsilon, epsilon is required in Pessoa 1.2.

function pss_vectarrow(p0,p1)

%
% Arrowline 3-D vector plot. vectarrow(p0,p1) plots a line vector with
% arrow pointing from point p0 to point p1. The function can plot both 2D 
% and 3D vectors with arrow depending on the dimension of the input
%
%   Example:
%       3D vector
...
%   Originally from: Rentian Xiong 4-18-05
%   $Revision: 1.0
